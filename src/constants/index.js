...
const experiences = [
  ...
  },
  {
    ...
    iconBg: "#383E56",
    points: [
     "Engineered a comprehensive platform for IT courses with secure authentication, interactive coding tools, and personalized learning.",
     "Tools and Technologies Used: React, Express, MongoDB, JWT, Framer Motion",
      "Built secure LMS with JWT authentication, managing 100+ users via Express.js and Mongoose.",
      "Developed real-time code compiler (C++/Python) using Monaco Editor, achieving 30% faster load times via Vite optimizations",
     " Designed interactive UI with Framer Motion and Tailwind CSS, boosting user engagement by 40%",
     ...
     "Scaled course management for 10+ modules using MongoDB, increasing user retention by 25% through personalized learning paths",
